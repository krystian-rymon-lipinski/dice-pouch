package com.krystianrymonlipinski.dicepouch.ui.theme
...
val md_theme_light_tertiaryContainer = Color(0xFF69F8E9)
...
val md_theme_dark_secondary = Color(0xFFFFBA31)
...
val md_theme_dark_tertiary = Color(0xFF46DCCD)
val md_theme_dark_onTertiary = Color(0xFF003732)
val md_theme_dark_tertiaryContainer = Color(0xFF00504A)
val md_theme_dark_onTertiaryContainer = Color(0xFF69F8E9)
...
val seed = Color(0xFFA85800)



val ColorScheme.dieAdvantage: Color
    @Composable get() = if (isSystemInDarkTheme()) dark_AdvantageGreen else light_AdvantageGreen

val ColorScheme.dieDisadvantage: Color
    @Composable get() = if (isSystemInDarkTheme()) dark_DisadvantageRed else light_DisadvantageRed

val light_AdvantageGreen = Color(0xFF366B00)
val dark_AdvantageGreen = Color(0xFF90DA53)
val light_DisadvantageRed = Color(0xFFBA1D00)
val dark_DisadvantageRed = Color(0xFFFFB4A5)
